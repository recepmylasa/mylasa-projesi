...
export default function RouteFilterSheet({
  ...
  const [groupBy, setGroupBy] = useState(initial.groupBy || "none");
  ...
  useEffect(() => {
    ...
    setGroupBy(initial.groupBy || "none");
  }, [open, initial]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Gruplama — tamamen sheet'e taşındı */}
        <div style={row}>
          <div style={label}>Gruplama</div>
          <div style={chipWrap}>
            {[
              ["none", "Yok"],
              ["city", "Şehir"],
          ...
          <div style={rangeRow}>
            <div>
              ...
              <input
                ...
                value={dist[0]}
                onChange={(e) =>
                  setDist([Number(e.target.value), dist[1]])
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                value={dist[1]}
                onChange={(e) =>
                  setDist([dist[0], Number(e.target.value)])
                }
              />
            </div>
          </div>
          ...
          <div style={rangeRow}>
            <div>
              ...
              <input
                ...
                value={dur[0]}
                onChange={(e) =>
                  setDur([Number(e.target.value), dur[1]])
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                value={dur[1]}
                onChange={(e) =>
                  setDur([dur[0], Number(e.target.value)])
                }
              />
            </div>
          </div>
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 14 }}>
          <button
            style={{ ...btn, background: "#eee", color: "#333", flex: 1 }}
            onClick={onClose}
            type="button"
          >
            Kapat
