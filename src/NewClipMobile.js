...
// --- İkonlar ---
const BackArrowIcon = () => <svg aria-label="Geri" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M21 11.3H5.7l6.2-6.2c.5-.5.5-1.3 0-1.8s-1.3-.5-1.8 0l-8.1 8.1c.5.5-.5 1.3 0 1.8l8.1 8.1c.5.5 1.3 .5 1.8 0s.5-1.3 0-1.8l-6.2-6.2H21c.7 0 1.3-.6 1.3-1.3s-.6-1.3-1.3-1.3z"></path></svg>;
const ChevronRightIcon = () => <svg aria-label="İleri" fill="#c7c7c7" height="16" role="img" viewBox="0 0 24 24" width="16"><path d="M9 18l6-6-6-6" stroke="#c7c7c7" strokeWidth="2"></path></svg>;
const TagPeopleIcon = () => <svg aria-label="Kişileri etiketle" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M12 12a3 3 0 100-6 3 3 0 000 6z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path><path d="M18.7 20.3a9.5 9.5 0 00-13.4 0" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path><path d="M21.5 12.5a9.5 9.5 0 10-19 0" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path></svg>;
const LocationIcon = () => <svg aria-label="Konum" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M12 2a8 8 0 00-8 8c0 5.4 6.3 11.4 7.3 12.3a.9.9 0 001.4 0C13.7 21.4 20 15.4 20 10a8 8 0 00-8-8zm0 11a3 3 0 110-6 3 3 0 010 6z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>;
            ...
            {step === 2 && (
                <div className="new-clip-mobile-container">
                    <header className="new-clip-mobile-header">
                        {isUploading && <div className="upload-progress-bar" style={{ width: `${uploadProgress}%` }}></div>}
                        <button onClick={handleClose} className="header-icon-btn" disabled={isUploading}><BackArrowIcon /></button>
                    ...
                    <footer className="share-screen-footer">
                        <button className="footer-btn" disabled={isUploading}>Taslağı Kaydet</button>
                        <button className="footer-btn primary" onClick={handlePaylas} disabled={isUploading}>Paylaş</button>
                    </footer>
                </div>
            )}
        </div>
