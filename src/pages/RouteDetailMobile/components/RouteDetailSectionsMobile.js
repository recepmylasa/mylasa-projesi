...
export default function RouteDetailSectionsMobile({
  ...
  return (
    <div className="rd-sections">
      {/* ✅ TEK İÇERİK KURALI: sadece activeTab section mount edilir */}
      ...
      {/* ✅ Rapor: activeTab report ise SADECE rapor (edit modda zaten RouteDetailMobile tab’i stops’a çeviriyor) */}
