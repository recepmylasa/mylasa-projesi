 ...
 */
export const purgeOldShareEvents = functions
  .region("us-central1")
 ...
 */
export const exportShareAggCsv = functions
  .region("us-central1")
  .https.onCall(async (data, context) => {
    ...
    const header =
      "date,total_clicks,mode_pwa,mode_intent,mode_spa,platform_android,platform_ios,platform_desktop,first_ts,last_ts";
